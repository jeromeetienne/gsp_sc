...
image_png_buffer = matplotlib_renderer.render(canvas, viewports, cameras)

# Save the rendered image to a file
image_path = f"{__dirname__}/output/{os.path.basename(__file__).replace('.py', '')}_local_image.png"
...
image_png_data = network_renderer.render(canvas, viewports, cameras)
