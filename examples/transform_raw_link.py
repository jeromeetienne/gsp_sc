...
myTransform1 = TransformLinkLoad(data_url=url_npy).chain(TransformLinkLambda(lambda x: x * 2))
np_array1 = myTransform1.run()
print(f"Loaded array1: {np_array1}")

###############################################################################

myTransform2 = TransformLinkImmediate(np.array([10, 20, 30])).chain(TransformLinkMathOp("add", 5))
...
myTransform3 = TransformLinkImmediate(np.array([10, 20, 30])).chain(TransformLinkAssertShape((3,)))
