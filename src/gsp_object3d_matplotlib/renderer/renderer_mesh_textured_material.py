...
class RendererMeshTexturedMaterial:
    ...
    def render(
        ...
        assert material.texture is not None and material.texture.image_data.size > 0, "MeshTexturedMaterial requires a valid texture."
    ...
    def update_textured_face(
        ...
        texture_data = texture.image_data
