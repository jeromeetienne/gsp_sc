...
def test_deep_hierarchy_mixed_transforms():
...
def test_non_uniform_scale_and_rotation_quaternion_integrity():
    o = Object3D()
...
def test_traverse_root_and_remove():
    root = Object3D()
    root.name = "root"
    a = Object3D()
    a.name = "a"
